...
<?php echo $this->Form->create('User');?>
	...
	<fieldset>
 		<legend><?php __('Registro de Empresas');?></legend>
	<?php
   		echo $this->Form->input('Empresa.nombre_fantasia', array('label'=>'Nombre de fantasia de la empresa'));
   		echo $this->Form->input('Empresa.razon_social', array('label'=>'Razón social de la empresa'));

   		echo $this->Form->input('Empresa.rut', array('label'=>'Rut Empresa','style'=>'width:20%;float:left;'));
		echo $this->Form->input('Empresa.guion',array('style'=>'width:2%;float:left;'));
		echo $this->Form->input('Empresa.mision', array('label'=>'Misión de la empresa'));
   		echo $this->Form->input('Empresa.vision', array('label'=>'Visión de la empresa'));
		echo $this->Form->input('Empresa.sitio_web', array('label'=>'Sitio Web de la empresa'));
   		echo $this->Form->input('Empresa.resena_historica', array('label'=>'Reseña histórica de la empresa'));
		echo $this->Form->input('nombre', array('label'=>'Nombre encargado'));
		echo $this->Form->input('apellido',array('label'=>'Apellido encargado'));
		echo $this->Form->input('email',array('label'=>'Email encargado'));

		echo $this->Form->input('password',array('label'=>'Contraseña encargado'));
	...
	<div>
	<p><?php __('Arrastre desde la caja ubicada en el lado izquierdo a la caja del lado derecho las 3 propuestas de mayor valor para usted ordenándolas deacuerdo a su preferencia (la que está al tope es la de mayor valor)');?> </p>
	<div id="name2">
